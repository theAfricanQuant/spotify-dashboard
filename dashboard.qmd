---
title: "theAfricaQuant's Top 50 hits"
format: 
  dashboard: 
...
tth0 <- request("https://api.spotify.com/v1/playlists/37i9dQZF1DWY5Sv12eISGT") |> 
  req_method("GET") |> 
  req_headers(
...
tempo_list0 <- vector(mode = "list", length = 50)
for (i in 1:50) {
...
<div style="background-color: #7D3C98; color: white; border-radius: 10px; padding: 10px; text-align: center; display: flex; align-items: center; justify-content: center; height: 100%;">
  ...
  <span style="font-size: 1vw; width: 100%;">
    **I followed the step by step process presented by:**  [Melissa Van Bussel](https://www.melissavanbussel.com/) for [Posit's 2024 Table Contest](https://posit.co/blog/announcing-the-2024-table-contest/).<br> The tutorial for this dashboard [here](https://melissavanbussel.github.io/spotify-dashboard). The code I used to build my dashboard can be found [here](https://github.com/theAfricanQuant/spotify-dashboard).
  </span>
